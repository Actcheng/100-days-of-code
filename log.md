...
**Thoughts:** Learnt how to pull an Object from an Array, and how to sort and limit after find. Spent some time to show the message board (the missing '/' in '/b/test/'). Remaining work: encrypt "delete password, functional tests, Heroku app. Computer was slow.
...
**Thoughts:** Very sleepy, just got part of the db promises work.
...
**Thoughts:** Copied some code but didn't worked.
...
**Resources:**
[JavaScript, HTML, CSS - Rock Paper Scissors Game](https://www.youtube.com/watch?v=jaVNP3nIAv0&t=172s)
...
**Today's Progress:** Finished on React and Redux for Front End Libraries Certification on #freecodecamp. 6 FCC challenges completed. 
...
**Today's Progress:** Completed Intermediate Algorithm Scripting for Javascript Algorithms And Data Structures Certification on #freecodecamp. Worked on 4 challenges in the certification projects. Total 12 challenges done.

**Thoughts:**  Need revisiting when have time. The projects are kind of easy, only about the medium level in leetcode.
...
**Today's Progress:** Completed Basic Data Structure and Basic Algorithm Scripting for Javascript Algorithms And Data Structures Certification on #freecodecamp. 27 challenges done.

**Thoughts:**  Both are quite easy, but helped me to get familiar with the syntax. The last few challenges need some thinking though.
...
**Thoughts:**  Debugging is what I am doing EVERYDAY.
...
**Thoughts:** So happy to make a left side navbar. Used the content for python standard library. A bit waste of time to copy and paste the documentation content and put the p and code wrappings by hand.
